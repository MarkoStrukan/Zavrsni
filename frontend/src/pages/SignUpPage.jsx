        ...
        <div className="w-full lg:w-1/2 p-4 sm:p-8 flex flex-col">
         ...
         {(error || passwordError) && (
          <div className="alert alert-error mb-4">
           <span>{passwordError || error?.response?.data?.message}</span>
          </div>
         )}
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-sm opacity-75">
                    Join TalkNest and start your conversation!
                  </p>
                </div>
        ...
        <div className="hidden lg:flex w-full lg:w-1/2 bg-primary/10 items-center justify-center">
          <div className="max-w-md p-8">
            <div className="relative aspect-square max-w-sm mx-auto">
              <img src="/Texting-bro.png" alt="Messages illustration" className="w-full h-full" />
            </div>

            <div className="text-center space-y-3 mt-6">
              <h2 className="text-xl font-semibold">Connect with your friends worldwide!</h2>
              <p className="opacity-70">Chat with your friends and family from anywhere in the world!</p>
            </div>
